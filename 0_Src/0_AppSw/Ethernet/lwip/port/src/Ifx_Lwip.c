...
void Ifx_Lwip_pollReceiveFlags(void)
{
     ...
     */
    if (ETH_Receive_Flag == TRUE)
    {
        ifx_netif_input(&g_Lwip.netif);
        ETH_Receive_Flag = FALSE;
    }
}
...
void Ifx_Lwip_init(eth_addr_t ethAddr)
{
    ...
    LWIP_DEBUGF(IFX_LWIP_DEBUG | LWIP_DBG_STATE, ("Ifx_Lwip_init start!\n"));
